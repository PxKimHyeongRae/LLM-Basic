...
def main():
    ...
    OUTPUT_DIR = "./finetuned_model_park"

    # 공원 특화 데이터 사용
    TRAIN_FILE = "data/train_park.jsonl"
    VAL_FILE = "data/validation_park.jsonl"

    print("=" * 70)
    print(f"🚀 공원 특화 파인튜닝 시작: {MODEL_NAME}")
    print("   대량의 다양한 공원 메시지 데이터 사용")
